...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>DINAS PMB HIMSI UNSRI</title>
...
<script src="assets/js/sweetalert2.js"></script>
                    ...
                    <?php
                         $urut = (isset($_GET['id']) ? strtolower($_GET['id']) : NULL); 
                            ...
                            if(mysqli_num_rows($sql) == 0){
                                echo "<script>
			                    Swal.fire('NIM yang anda masukan salah!!.', 'Coba cek lagi NIMnya', 'success').then(function(){
        ...
        <footer id="footer">
            ...
            <p class="pad-lft">&#0169; 2018 SI Bilingual 2A</p>
