...
<html lang="en">
  <head>
    ...
    <link href="cssa/stylesheet.css" rel="stylesheet">
  ...
  <div class="container">
    <div class="col-md-12 col-sm-12 py-3">
        <div class="card">
          ...
          <div class="table">
            <br>
            <form class= method="post" action="proses.php?id=<?php echo $id;?>">
               ...
               <thead>
                ...
                <tbody>
                  ...
                  ?>
                        <tr>
                          <td></td>
                          <td class="text-center"><b><?php echo $tampil['nama_domain']?></b></td>
                          <td></td>
                        </tr>
                  <?php
                        $no++;
                  ...
                  ?>
                        ...
                        <tr>
                          ...
                          <div class="form-check form-check-inline " >
                            <input class="form-check-input" type="radio" id="1" value="<?php echo $satu;?>" name="dom1[]" >
                            <label class="form-check-label" for="1">1</label>
                                </div>
                                <div class="form-check form-check-inline">
                            <input class="form-check-input " type="radio" id="2" value="<?php echo $dua;?>" name="dom1[]">
                            <label class="form-check-label" for="2">2</label>
                                </div>
                                <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="3" value="<?php echo $tiga;?>" name="dom1[]">
                            <label class="form-check-label" for="3">3</label>
                                </div>
                                <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="4" value="<?php echo $empat;?>" name="dom1[]">
