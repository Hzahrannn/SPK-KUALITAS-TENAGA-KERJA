                                    ...
                                    <?php
                                            include "koneksi.php";
                                                ...
                                                while($data = mysqli_fetch_array($query)){
                                                    ...
                                                    $kontak = $data["kontak"];
                                                    $seni = $data["seni"];
                                                    $alat_musik = $data["alat_musik"];
                                                    $olahraga = $data["olahraga"];
                                                    $prestasi = $data["prestasi"];
                                                    $gambar = $data["gambar"];
                                                    $gambarex = explode (", ", $gambar);
                                                    // $gambar = 'uploads/'.explode (", ",$data["gambar"]);
                                                    ...
                                                    echo "<tr>
                                                            ...
                                                            <td>$prestasi</td>
                                                            <td>";
                                                            foreach($gambarex as $item){
                                                                echo "<a href='../uploads/$item' target='_blank'>$item <a/>";
                                                            }
                                                          echo "<td></tr>";
